...
To make the Javadoc more convenient to use we decided to host it online using github's free hosting.  A build file was written to auto-generate all the Javadoc and commit it to the correct branch of the repo and then push it to our repository, allowing us online access.  This was not trivial and we could not find a guide for it so our technique has been written up and posted online at\cite{javadoc}
