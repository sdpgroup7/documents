...
unpredictably with these commands. The issue was narrow down to bluetooth buffering 
issues and it meant that we had no idea what command the robot was currently executing. 
This was a problem.
